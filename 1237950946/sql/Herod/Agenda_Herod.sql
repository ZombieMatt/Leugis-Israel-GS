...
VALUES	('LEU_HEROD_CONQUEROR_LOVER',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',		'LEUGENDA_HAS_MANY_CAPTURED_CITIES');

INSERT OR REPLACE INTO ModifierArguments
		(ModifierId,						Name,							Value)
VALUES	('LEU_HEROD_CONQUEROR_LOVER',		'InitialValue',					10),
		('LEU_HEROD_CONQUEROR_LOVER',		'StatementKey',					'LOC_DIPLO_KUDO_EXIT_LEADER_LEU_HEROD_CONQUEROR_LOVER'),
		('LEU_HEROD_CONQUEROR_LOVER',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_LEU_HEROD_CONQUEROR_LOVER'),
		('LEU_HEROD_CONQUEROR_LOVER',		'HiddenAgenda',					0);
...
VALUES	('LEU_ISR_REQUIRES_MANY_CAPTURES',	'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
...
--==========================================================================================================================
--==========================================================================================================================
-- Poor Hater WORKS DON'T TOUCH
-------------------------------------
INSERT OR REPLACE INTO Modifiers	
		(ModifierId,							ModifierType,										SubjectRequirementSetId)
VALUES	('LEU_HEROD_POOR_HATER',				'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',		'LEUGENDA_IS_POOR');

INSERT OR REPLACE INTO ModifierArguments
		(ModifierId,					Name,							Value)
VALUES	('LEU_HEROD_POOR_HATER',		'InitialValue',					-7),
		('LEU_HEROD_POOR_HATER',		'StatementKey',					'LOC_DIPLO_WARNING_EXIT_LEADER_LEU_HEROD_POOR_HATER'),
		('LEU_HEROD_POOR_HATER',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_LEU_HEROD_POOR_HATER'),
		('LEU_HEROD_POOR_HATER',		'HiddenAgenda',					0);
...
--==========================================================================================================================
--==========================================================================================================================
-- Denounce Hater WORKS DONT TOUCH
-------------------------------------
INSERT OR REPLACE INTO Modifiers	
		(ModifierId,						ModifierType)
VALUES	('LEU_HEROD_DENOUNCER_HATER',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER');

INSERT OR REPLACE INTO ModifierArguments
		(ModifierId,						Name,							Value)
VALUES	('LEU_HEROD_DENOUNCER_HATER',		'InitialValue',					-10),
		('LEU_HEROD_DENOUNCER_HATER',		'StatementKey',					'LOC_DIPLO_WARNING_EXIT_LEADER_LEU_HEROD_DENOUNCER_HATER'),
		('LEU_HEROD_DENOUNCER_HATER',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_LEU_HEROD_DENOUNCER_HATER'),
		('LEU_HEROD_DENOUNCER_HATER',		'HiddenAgenda',					true);
